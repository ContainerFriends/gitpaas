...
export const servicePrismaMapper = {
    toDomain: (prismaService: PrismaService): Service => ({
        ...
        gitProviderId: prismaService.gitProviderId || '',
        repositoryId: prismaService.repositoryId || '',
        branch: prismaService.branch || '',
        composePath: prismaService.composePath || '',
    ...
    toPersistenceUpdate: (updateDto: UpdateServiceDto): any => {
        ...
        if (updateDto.gitProviderId !== undefined) updateData.gitProviderId = updateDto.gitProviderId;
        ...
        if (updateDto.composePath !== undefined) updateData.composePath = updateDto.composePath;
        return updateData;
    },
};
