...
const deployments: Deployment[] = [
  { id: "1", project: "frontend-app", branch: "main", commit: "fix: auth redirect", status: "success", time: "2 min ago", duration: "1m 23s" },
  { id: "2", project: "api-gateway", branch: "develop", commit: "feat: rate limiting", status: "deploying", time: "5 min ago", duration: "—" },
  { id: "3", project: "landing-page", branch: "main", commit: "update hero section", status: "success", time: "12 min ago", duration: "45s" },
  { id: "4", project: "worker-service", branch: "feat/queue", commit: "add retry logic", status: "failed", time: "28 min ago", duration: "2m 01s" },
  { id: "5", project: "docs-site", branch: "main", commit: "update api reference", status: "success", time: "1h ago", duration: "32s" },
  { id: "6", project: "admin-panel", branch: "main", commit: "fix: table pagination", status: "queued", time: "just now", duration: "—" },
];
        ...
        {deployments.map((d) => (
          ...
          >
            ...
            <div className="text-right shrink-0">
              <span className={`text-xs font-medium ${statusStyles[d.status]}`}>
