...
import { ProjectStatusConfig } from '../../domain/models/projects.models';
...
export function ProjectsListContainer(): ReactNode {
    const {
 filteredProjects, filter, loading, error, actions 
} = useProjects();
                    ...
                    >
                        <div className="flex items-start justify-between mb-3">
                            <div className="flex items-center gap-2.5">
                                <div className={ProjectStatusConfig.statusDot[project.status]} />
                                <div>
                        ...
                        <div className="flex items-center justify-between mt-4 pt-3 border-t border-border">
                            <span className={`text-[11px] font-medium ${ProjectStatusConfig.statusText[project.status]}`}>
                                {ProjectStatusConfig.statusLabel[project.status]}
                            </span>
