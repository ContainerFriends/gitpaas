...
const servers = [
  { name: "prod-01", status: "running" as const, cpu: 34, ram: 62, disk: 45 },
  { name: "prod-02", status: "running" as const, cpu: 12, ram: 38, disk: 22 },
  { name: "staging", status: "running" as const, cpu: 8, ram: 24, disk: 15 },
  { name: "dev-01", status: "stopped" as const, cpu: 0, ram: 0, disk: 67 },
];
