...
const stats = [
  { label: "Projects", value: "12", icon: Layers, change: "+2 this week" },
  { label: "Deployments", value: "148", icon: Globe, change: "23 today" },
  { label: "Servers", value: "4", icon: Server, change: "All healthy" },
