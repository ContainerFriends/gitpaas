...
const projects: Project[] = [
  { id: "1", name: "frontend-app", type: "Next.js", status: "running", domain: "app.example.com", branch: "main", lastDeploy: "2 min ago", deployCount: 48 },
  { id: "2", name: "api-gateway", type: "Node.js", status: "deploying", domain: "api.example.com", branch: "develop", lastDeploy: "5 min ago", deployCount: 124 },
  { id: "3", name: "landing-page", type: "Static", status: "running", domain: "example.com", branch: "main", lastDeploy: "12 min ago", deployCount: 31 },
  { id: "4", name: "worker-service", type: "Docker", status: "error", domain: "—", branch: "feat/queue", lastDeploy: "28 min ago", deployCount: 67 },
  { id: "5", name: "docs-site", type: "VitePress", status: "running", domain: "docs.example.com", branch: "main", lastDeploy: "1h ago", deployCount: 19 },
  { id: "6", name: "admin-panel", type: "React", status: "stopped", domain: "admin.example.com", branch: "main", lastDeploy: "3h ago", deployCount: 42 },
  { id: "7", name: "auth-service", type: "Go", status: "running", domain: "auth.example.com", branch: "main", lastDeploy: "6h ago", deployCount: 88 },
  { id: "8", name: "cdn-proxy", type: "Nginx", status: "running", domain: "cdn.example.com", branch: "main", lastDeploy: "2d ago", deployCount: 5 },
];
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mt-4 pt-3 border-t border-border">
                <span className={`text-[11px] font-medium ${statusText[project.status]}`}>
